...
async def initiate_call(
    ...
    elif telephony_configuration_id is not None:
        default_phone = await db_client.get_default_caller_id(telephony_configuration_id)
        if default_phone and default_phone.is_active:
            from_number = default_phone.address_normalized
